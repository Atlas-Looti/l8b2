...
- `--tunnel` - Enable tunneling for Farcaster Mini Apps testing
...
When developing Farcaster Mini Apps, you need a public HTTPS URL. Use the `--tunnel` flag:
...
- Update `/.well-known/farcaster.json` with tunnel URL
...
**Note:** Make sure to run `l8b build` before `l8b start`.
