...
export class Screen extends TriangleScreen {
      getInterface(): ScreenInterface {
            ...
            this.interfaceCache = {
                  ...
                  fillRect: (x: number, y: number, w: number, h: number, c?: string | number) =>
                  ...
                  fillRound: (x: number, y: number, w: number, h: number, c?: string | number) =>
                        screen.fillRound(x, y, w, h, c),
                  drawRect: (x: number, y: number, w: number, h: number, c?: string | number) =>
                  ...
                  drawRound: (x: number, y: number, w: number, h: number, c?: string | number) =>
                  ...
                  drawMap: (map: Map | string, x: number, y: number, w: number, h: number) =>
