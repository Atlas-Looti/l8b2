...
export class Program {
	 ...
	 */
	static CreateFieldAccess(token: Token, expression: Statement, field: Statement): Field {
	 ...
	 */
	static BuildOperations(ops: Array<{ token: Token; operation: string }>, terms: Statement[]): Operation {
		let i: number;
		let o: Operation;
...
export class Assignment extends Expression {
	...
	constructor(token: Token, field: Statement | null, expression: Statement, local: boolean) {
		super();
		this.token = token;
		this.field = field;
...
export class SelfAssignment extends Expression {
	...
	constructor(token: Token, field: Statement | null, operation: string, expression: Statement) {
		super();
		this.token = token;
		this.field = field;
...
export class Field extends Expression {
	...
	constructor(token: Token, expression: Statement, chain: Statement[]) {
		...
		this.expression = expression;
		this.chain = chain;
		this.token = expression instanceof Expression ? (expression as any).token : token;
	}
...
export class Operation extends Expression {
	...
	constructor(token: Token, operation: string, term1: Statement, term2: Statement) {
		super();
		this.token = token;
		this.operation = operation;
		this.term1 = term1;
...
export class ForIn extends Expression {
	...
	constructor(token: Token, iterator: string, list: Statement, sequence: Statement[]) {
		super();
		this.token = token;
		this.iterator = iterator;
		this.list = list;
...
export class Function extends Expression {
	...
	constructor(token: Token, args: FunctionArg[], sequence: Statement[], end: Token) {
		super();
		this.token = token;
		this.args = args;
		this.sequence = sequence;
...
export class CreateObject extends Expression {
	...
	constructor(token: Token, fields: Array<{ field: string | number | null; value: Statement }>) {
		super();
		this.token = token;
		this.fields = fields;
	}
...
export class CreateClass extends Expression {
	...
	constructor(token: Token, ext: Statement | null, fields: Array<{ field: string | number; value: Statement }>) {
		super();
		this.token = token;
		this.ext = ext;
		this.fields = fields;
...
export class After extends Expression {
	...
	constructor(token: Token, delay: Statement, sequence: Statement[], end: Token, multiplier: number | null) {
		super();
		this.token = token;
		this.delay = delay;
		this.sequence = sequence;
