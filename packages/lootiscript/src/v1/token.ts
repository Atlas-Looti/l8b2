...
export class Token {
      ...
      constructor(tokenizer: Tokenizer, type: number, value: string | number, string_value?: string) {
            ...
            if (this.type === Token.TYPE_IDENTIFIER && Object.hasOwn(Token.predefined, String(this.value))) {
